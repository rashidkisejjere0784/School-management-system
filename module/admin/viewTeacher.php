...
while($row = mysqli_fetch_array($res)){
    ...
    "</td><td><img src='".$images_dir.$picname.".jpg' alt='$picname' class='img-thumbnail' width='150' height='150'>".'</td></tr>';
}
?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="searchId" placeholder="Search By Id Or Name:" onkeyup="getTeacher(this.value);">
                        </div>
                    </div>
                </div>
                <div class="row">
